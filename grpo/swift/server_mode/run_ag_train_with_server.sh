...
export COMET_PROJECT_NAME="${COMET_PROJECT_NAME:-qwen3_5_1b_grpo_ag_server_1gpu_train_1gpu_rollout}"
...
swift rlhf \
  ...
  --save_steps 1000 \
  --save_total_limit 30 \
  --output_dir "${MODEL_ROOT}/qwen3_5_1b_grpo_ag_server_1gpu_train_1gpu_rollout" \
